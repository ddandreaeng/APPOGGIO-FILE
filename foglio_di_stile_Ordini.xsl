								...
								<table class="dati-documento h100" summary="Dati ordine e contratto">
									<tr>
										...
										<td class="w-33 no-border h50">
											...
											<span class="box-text">
												<xsl:if test="/in:Order/cac:Delivery/cac:Shipment/cbc:ShippingPriorityLevelCode">
												<xsl:variable name ="shippingPriorityLevelCode" select="/in:Order/cac:Delivery/cac:Shipment/cbc:ShippingPriorityLevelCode"/>
