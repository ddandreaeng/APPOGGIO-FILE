...
Intercent-ER
	...
	<xsl:param name="xclTransportPriorityCode"/>
		...
		<html>
			...
			<body class="in-body">
				<div class="page-break">
					...
					<div class="box-text">
                        CustomizationID: <xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cbc:CustomizationID"/>
						<br/>
                        ProfileID: <xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cbc:ProfileID"/>
					</div>
						...
						<tr class="party-row">
							<td class="party-column">
								...
								<xsl:call-template name="in-party">
									<xsl:with-param name="party" select="/sbd:StandardBusinessDocument/in:Order/cac:BuyerCustomerParty/cac:Party"/>
								</xsl:call-template>
							</td>
							<td>
											...
											<span class="box-text">
												<xsl:call-template name="format-date">
													<xsl:with-param name="date">
														<xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cbc:IssueDate"/>
													</xsl:with-param>
												</xsl:call-template>
												<xsl:if test="/sbd:StandardBusinessDocument/in:Order/cbc:IssueTime">
ora
                                                <xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cbc:IssueTime"/>
												</xsl:if>
											</span>
										</td>
								...
								<table class="dati-fattura h80">
									<tr>
										<td class="no-border border-bottom w-100">
											...
											<div class="box-text">
												<xsl:choose>
													<xsl:when test="/sbd:StandardBusinessDocument/in:Order/cbc:OrderTypeCode = '227'">
								...
								<table class="dati-fattura h80">
									<tr>
										<td class="no-border border-bottom w-100">
											...
											<div class="box-text">
												<xsl:choose>
													<xsl:when test="contains(/sbd:StandardBusinessDocument/in:Order/cac:OrderDocumentReference/cbc:ID, 'Cancelled')">
														<span>ORDINE DI REVOCA</span>
													</xsl:when>
													<xsl:when test="contains(/sbd:StandardBusinessDocument/in:Order/cac:OrderDocumentReference/cbc:ID, 'Revised')">
														<span>ORDINE SOSTITUTIVO</span>
													</xsl:when>
													<xsl:when test="contains(/sbd:StandardBusinessDocument/in:Order/cac:OrderDocumentReference/cbc:ID, 'Connected')">
														<span>ORDINE COLLEGATO</span>
													</xsl:when>
													<xsl:when test="contains(/sbd:StandardBusinessDocument/in:Order/cac:OrderDocumentReference/cbc:ID, 'Invoice')">
								...
								<table class="dati-fattura">
									<tr>
										<td class="no-border border-right w-33 h100px">
											...
											<xsl:if test="/sbd:StandardBusinessDocument/in:Order/cac:OrderDocumentReference">
												<div class="box-text">
Numero:
                                                <xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cac:OrderDocumentReference/cbc:ID"/>
												</div>
											</xsl:if>
										</td>
										<td class="no-border border-right w-33 h100px">
											<h2 class="in-box-label">Codice identificativo gara (CIG)</h2>
											<xsl:if test="/sbd:StandardBusinessDocument/in:Order/cac:OriginatorDocumentReference">
												<div class="box-text">
													<xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cac:OriginatorDocumentReference/cbc:ID"/>
												</div>
											</xsl:if>
										</td>
										<td class="no-border w-33 h100px">
											<h2 class="in-box-label">Contratto</h2>
											<xsl:if test="/sbd:StandardBusinessDocument/in:Order/cac:Contract">
												<div class="box-text">
Numero:
                                                <xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cac:Contract/cbc:ID"/>
												</div>
											</xsl:if>
										</td>
									</tr>
						...
						<tr class="party-row">
							<td>
								...
								<xsl:call-template name="in-party">
									<xsl:with-param name="party" select="/sbd:StandardBusinessDocument/in:Order/cac:SellerSupplierParty/cac:Party"/>
								</xsl:call-template>
							</td>
							<td>
								<table class="dati-fattura" summary="Note e riferimento amministrativo">
									<tr>
										<td class="no-border border-right w-33 border-bottom">
											...
											<div class="box-text">
												<xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cbc:AccountingCost"/>
											</div>
										</td>
										<td class="no-border border-right w-33 border-bottom">
											...
											<div class="box-text">
												<xsl:call-template name="format-date">
													<xsl:with-param name="date">
														<xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cac:ValidityPeriod/cbc:EndDate"/>
													</xsl:with-param>
												</xsl:call-template>
											</div>
										</td>
										<td class="no-border w-33 border-bottom">
											...
											<span class="box-text">
												<xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cac:PaymentTerms/cbc:Note"/>
											</span>
										</td>
									</tr>
						...
						<tr class="h50">
							<td>
								...
								<xsl:call-template name="in-party">
									<xsl:with-param name="party" select="/sbd:StandardBusinessDocument/in:Order/cac:OriginatorCustomerParty/cac:Party"/>
								</xsl:call-template>
							</td>
							<td class="h50">
									...
									<tr>
										<td class="w-66 no-border border-right h50">
											...
											<xsl:call-template name="delivery">
												<xsl:with-param name="del" select="/sbd:StandardBusinessDocument/in:Order/cac:Delivery"/>
											</xsl:call-template>
										</td>
										<td class="w-33 no-border h50">
											<h2 class="in-box-label">Termini di consegna</h2>
											<span class="box-text">
												<xsl:if test="/sbd:StandardBusinessDocument/in:Order/cac:DeliveryTerms/cac:DeliveryLocation">
													<xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cac:DeliveryTerms/cac:DeliveryLocation"/>
												</xsl:if>
											</span>
											<span class="box-text">
												<xsl:if test="/sbd:StandardBusinessDocument/in:Order/cac:Delivery/cac:Shipment/cbc:ShippingPriorityLevelCode">
												<xsl:variable name ="shippingPriorityLevelCode" select="/sbd:StandardBusinessDocument/in:Order/cac:Delivery/cac:Shipment/cbc:ShippingPriorityLevelCode"/>
													Priorità: <xsl:value-of select="document($xclTransportPriorityCode)//cl:Code[cl:Id=$shippingPriorityLevelCode]/cl:LocalDescription"/>
												</xsl:if>
											</span>	
										</td>
									</tr>
						...
						<tr class="h50">
							<td>
								...
								<xsl:call-template name="in-party">
									<xsl:with-param name="party" select="/sbd:StandardBusinessDocument/in:Order/cac:AccountingCustomerParty/cac:Party"/>
								</xsl:call-template>
							</td>
							<td>
								<h2 class="in-box-label">Altri Riferimenti</h2>
								<xsl:for-each select="/sbd:StandardBusinessDocument/in:Order/cac:AdditionalDocumentReference">
									<div class="box-text">
										<xsl:choose>
					...
					<table class="righe-fattura" summary="righe fattura">
						<thead>
							<tr>
								...
								<th scope="col" class="in-cell-filler-background">Seriale</th>
						...
						<tbody>
							<xsl:for-each select="/sbd:StandardBusinessDocument/in:Order/cac:OrderLine">
								<tr>
...
Consegna parziale:
									...
									<td class="in-cell-base in-cell-data-center">
										<div class="box-text" align="right">
											<xsl:value-of select="cac:LineItem/cac:Item/cac:ItemInstance/cbc:SerialID"/>
										</div>
									</td>
									...
									<td class="in-cell-base in-cell-data-center">
										<div class="box-text" align="right">
											<ul class="allowance-charge">
												<xsl:for-each select="cac:LineItem/cac:AllowanceCharge">
													<xsl:if test = "cbc:ChargeIndicator eq 'false'">
														<li>
															<xsl:value-of select="cbc:AllowanceChargeReason"/>
															<xsl:text>: </xsl:text>
															<xsl:text> Sconto </xsl:text>
	...
	su
													...
													<xsl:if test = "cbc:ChargeIndicator eq 'true'">
														<li>
															<xsl:value-of select="cbc:AllowanceChargeReason"/>
															<xsl:text>: </xsl:text>
															<xsl:text> Maggiorazione </xsl:text>
															<xsl:if test="cbc:MultiplierFactorNumeric">
																<xsl:text>(</xsl:text>
																<xsl:value-of select="cbc:MultiplierFactorNumeric"/>
																<xsl:text>%): </xsl:text>
...
su
				...
				<xsl:if test="/sbd:StandardBusinessDocument/in:Order/cac:AllowanceCharge">
					<div class="page-break">
						...
						<table id="allowance-charge" class="riepilogo-PDC w-50" summary="Subtotali">
							...
							<tbody>
								<xsl:for-each select="/sbd:StandardBusinessDocument/in:Order/cac:AllowanceCharge">
									<tr>
										<td class="in-cell-base in-cell-data-center">
						...
						<tbody>
							<tr>
								...
								<td class="in-cell-base in-cell-data-center box-text">
									<xsl:call-template name="format-amount">
										<xsl:with-param name="amount">
											<xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cac:AnticipatedMonetaryTotal/cbc:LineExtensionAmount"/>
										</xsl:with-param>
									</xsl:call-template>
								</td>
							</tr>
							<tr>
								...
								<td class="in-cell-base in-cell-data-center box-text">
									<xsl:call-template name="format-amount">
										<xsl:with-param name="amount">
											<xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cac:AnticipatedMonetaryTotal/cbc:AllowanceTotalAmount"/>
										</xsl:with-param>
									</xsl:call-template>
								</td>
							</tr>
							<tr>
								...
								<td class="in-cell-base in-cell-data-center box-text">
									<xsl:call-template name="format-amount">
										<xsl:with-param name="amount">
											<xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cac:AnticipatedMonetaryTotal/cbc:ChargeTotalAmount"/>
										</xsl:with-param>
									</xsl:call-template>
								</td>
							</tr>
							<tr>
								...
								<td class="in-cell-base in-cell-data-center box-text">
									<xsl:call-template name="format-amount">
										<xsl:with-param name="amount">
											<xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cac:AnticipatedMonetaryTotal/cbc:TaxExclusiveAmount"/>
										</xsl:with-param>
									</xsl:call-template>
								</td>
							</tr>
							<tr>
								...
								<td class="in-cell-base in-cell-data-center box-text">
									<xsl:call-template name="format-amount">
										<xsl:with-param name="amount">
											<xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cac:TaxTotal/cbc:TaxAmount"/>
										</xsl:with-param>
									</xsl:call-template>
								</td>
							</tr>
							<tr>
								...
								<td class="in-cell-base in-cell-data-center box-text">
									<xsl:call-template name="format-amount">
										<xsl:with-param name="amount">
											<xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cac:AnticipatedMonetaryTotal/cbc:PayableRoundingAmount"/>
										</xsl:with-param>
									</xsl:call-template>
								</td>
							</tr>
							<tr>
								...
								<td class="in-cell-base in-cell-data-center box-text">
									<xsl:call-template name="format-amount">
										<xsl:with-param name="amount">
											<xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cac:AnticipatedMonetaryTotal/cbc:TaxInclusiveAmount"/>
										</xsl:with-param>
									</xsl:call-template>
								</td>
							</tr>
							<tr>
								...
								<td class="in-cell-base in-cell-data-center box-text">
									<xsl:call-template name="format-amount">
										<xsl:with-param name="amount">
											<xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cac:AnticipatedMonetaryTotal/cbc:PrepaidAmount"/>
										</xsl:with-param>
									</xsl:call-template>
								</td>
							</tr>
							<tr>
								...
								<td class="in-cell-base in-cell-data-center box-text bold font-size-80">
									<xsl:call-template name="format-amount">
										<xsl:with-param name="amount">
											<xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cac:AnticipatedMonetaryTotal/cbc:PayableAmount"/>
										</xsl:with-param>
									</xsl:call-template>
								</td>
							</tr>
				...
				<xsl:if test="/sbd:StandardBusinessDocument/in:Order/cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject">
					<div style="margin-top: 10px" class="page-break">
						<xsl:variable name="NumAllegati">
							<xsl:value-of select="count(/sbd:StandardBusinessDocument/in:Order/cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject)"/>
						</xsl:variable>
						<div class="box-text">
...
allegati:
							...
							<ul style="margin: 0; padding: 0" class="attachment-list">
								<xsl:for-each select="/sbd:StandardBusinessDocument/in:Order/cac:AdditionalDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject">
									<li>
										<xsl:value-of select="../../cbc:DocumentType"/>
...
(
	...
	<xsl:template name="in-id">
		<span class="box-text">
			<xsl:apply-templates mode="line" select="/sbd:StandardBusinessDocument/in:Order/cbc:ID"/>
		</span>
	</xsl:template>
	<xsl:template name="in-currency">
		<span class="box-text">
			<xsl:apply-templates mode="line" select="/sbd:StandardBusinessDocument/in:Order/cbc:DocumentCurrencyCode"/>
		</span>
	</xsl:template>
	...
	<xsl:template name="in-note">
		<ul style="border:0;padding:0;margin:0">
			<xsl:for-each select="/sbd:StandardBusinessDocument/in:Order/cbc:Note">
...
Codice IPA
	...
	<xsl:template name="order-type">
		...
		<xsl:choose>
			<xsl:when test="/sbd:StandardBusinessDocument/in:Order/cac:DeliveryTerms/cbc:SpecialTerms = 'OF'">
				<span>220 - Ordinazione di fatturazione (220#OF)</span>
			</xsl:when>
			<xsl:when test="/sbd:StandardBusinessDocument/in:Order/cac:DeliveryTerms/cbc:SpecialTerms = 'OFR'">
				<span>220 - Ordinazione di fatturazione e reintegro (220#OFR)</span>
			</xsl:when>
			<xsl:when test="/sbd:StandardBusinessDocument/in:Order/cac:DeliveryTerms/cbc:SpecialTerms = 'ON'">
				<span>220 - Ordinazione di noleggio (220#ON)</span>
			</xsl:when>
			<xsl:when test="/sbd:StandardBusinessDocument/in:Order/cac:DeliveryTerms/cbc:SpecialTerms = 'OR'">
				<span>220 - Ordinazione di regolazione (220#OR)</span>
			</xsl:when>
			<xsl:when test="/sbd:StandardBusinessDocument/in:Order/cac:DeliveryTerms/cbc:SpecialTerms = 'OB'">
				<span>220 - Ordinazione a budget (220#OB)</span>
			</xsl:when>
			<xsl:when test="/sbd:StandardBusinessDocument/in:Order/cac:DeliveryTerms/cbc:SpecialTerms = 'CD'">
				<span>227 - Ordinazione in conto deposito (227#CD)</span>
			</xsl:when>
			<xsl:when test="/sbd:StandardBusinessDocument/in:Order/cac:DeliveryTerms/cbc:SpecialTerms = 'CV'">
				<span>227 - Ordinazione in conto visione (227#CV)</span>
			</xsl:when>
			<xsl:when test="/sbd:StandardBusinessDocument/in:Order/cac:DeliveryTerms/cbc:SpecialTerms = 'CG'">
				<span>227 - Ordinazione in comodato gratuito (227#CG)</span>
			</xsl:when>
			<xsl:when test="/sbd:StandardBusinessDocument/in:Order/cac:DeliveryTerms/cbc:SpecialTerms = 'CN'">
				<span>227 - Ordinazione in conto noleggio (227#CN)</span>
			</xsl:when>
			<xsl:otherwise>
				<xsl:value-of select="$description"/>
				<xsl:if test="/sbd:StandardBusinessDocument/in:Order/cac:DeliveryTerms/cbc:SpecialTerms">
					<xsl:text>#</xsl:text>
					<xsl:value-of select="/sbd:StandardBusinessDocument/in:Order/cac:DeliveryTerms/cbc:SpecialTerms"/>
				</xsl:if>
				<xsl:text>)</xsl:text>
			</xsl:otherwise>
		</xsl:choose>
...
Data consegna al:
	...
	<xsl:template name="party-name">
		...
		<xsl:if test="$name/cbc:Name">
			Denominazione: <xsl:value-of select="$name/cbc:Name"/>
		</xsl:if>
	</xsl:template>
	<xsl:template name="postal-address">
		<xsl:param name="address"/>
		<xsl:if test="$address/cbc:StreetName">
		Indirizzo: <xsl:value-of select="concat($address/cbc:StreetName, ' ')"/>
		</xsl:if>
...
<!--		Denominazione:<xsl:value-of select="$legal-entity/cbc:RegistrationName"/> -->
